...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, RouterLink, WidgetTileComponent, StackChartComponent],
  template: `
      ...
      <div class="body">
        ...
        <section class="center">
          ...
          <div class="step-panel" *ngIf="selectedViz">
            ...
            <!-- Column pickers (not shown for Stack Chart - it has its own dataset/dimension/measure builder) -->
            <div class="cols" *ngIf="selectedViz !== 'stack'">
            ...
            <div class="preview" [class.stack-mode]="selectedViz === 'stack'">
              ...
              <!-- Stack Chart: fully self-contained (its own dataset/dimension/measure/filter UI) -->
              <div class="stack-embed" *ngIf="selectedViz === 'stack'">
  ...
  styles: [`
    ...
    .preview.stack-mode { display: block; padding: 0; border: none; background: transparent; min-height: auto; }
    .stack-embed { width: 100%; }
...
export class DashboardBuilderComponent {
  ...
  vizTypes: VizType[] = [
    ...
    { key: 'stack', label: 'STACK CHART', desc: 'Layered category breakdown', icon: `<svg viewBox="0 0 24 24" fill="none"><rect x="8" y="3" width="8" height="6" rx="1.3" fill="currentColor" opacity="0.35"/><rect x="8" y="9.5" width="8" height="6" rx="1.3" fill="currentColor" opacity="0.65"/><rect x="8" y="16" width="8" height="5" rx="1.3" fill="currentColor"/></svg>` },
  ...
  slotSpecs: { [k: string]: Slot[] } = {
    ...
    // Stack Chart manages its own dataset/dimension/measure/filter selection internally
    stack: [],
  ...
  addWidget() {
    // Stack Chart is a live, self-contained widget - it isn't committed as a static tile
    if (this.selectedViz === 'stack') { return; }

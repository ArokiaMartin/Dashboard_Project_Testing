...
@Component({
    ...
    <div class="auth-page-wrapper">
      ...
      <div class="bg-viz-canvas">
        <svg width="100%" height="100%" viewBox="0 0 1440 900" preserveAspectRatio="xMidYMid slice" fill="none">
          <defs>
            <linearGradient id="lineGradSignup1" x1="0%" y1="0%" x2="100%" y2="0%">
              <stop offset="0%" stop-color="#3b82f6" stop-opacity="0"/>
              <stop offset="50%" stop-color="#60a5fa" stop-opacity="0.8"/>
              <stop offset="100%" stop-color="#818cf8" stop-opacity="0"/>
            </linearGradient>
            <linearGradient id="lineGradSignup2" x1="0%" y1="0%" x2="100%" y2="0%">
          ...
          <path id="trendPath1" class="viz-trend-line line-1"
                ...
                stroke="url(#lineGradSignup1)" stroke-width="3.5" stroke-linecap="round" fill="none"/>
          ...
          <path id="trendPath2" class="viz-trend-line line-2"
                ...
                stroke="url(#lineGradSignup2)" stroke-width="2.5" stroke-linecap="round" fill="none"/>
        ...
        <div class="form-panel">
          <div class="form-wrapper">
            ...
            <div class="form-header">
              ...
              <p>Register your Lumina account using your Hyland email</p>
            </div>
            ...
            <form (ngSubmit)="onSubmit()" class="auth-form" novalidate>
              ...
              <div class="form-group">
                ...
                <div class="input-wrap" [class.invalid]="isEmailTouched && !isEmailValid">
                  ...
                  <input
                    ...
                    placeholder="your.name&#64;hyland.com"
                    required
                    autocomplete="email"
                  />
                </div>
              ...
              <button type="submit" class="btn-submit" [disabled]="loading">
                <span *ngIf="!loading">Create Hyland Account &rarr;</span>
            ...
            <div class="form-footer">
              Already have a Lumina account? <a routerLink="/login">Sign in now</a>
            </div>
          </div>
        </div>
      </div>
  ...
  styles: [`
    ...
    .toast.toast-error   { background: #fff; border: 1px solid #fecaca; border-left: 4px solid #ef4444; color: #0f172a; }
    .toast.toast-error .toast-icon { color: #ef4444; }
    .toast.toast-success { background: #fff; border: 1px solid #bbf7d0; border-left: 4px solid #22c55e; color: #0f172a; }
    .toast.toast-success .toast-icon { color: #22c55e; }
    .toast.toast-info    { background: #fff; border: 1px solid #bfdbfe; border-left: 4px solid #3b82f6; color: #0f172a; }
    ...
    .toast-close {
      ...
      display: flex; align-items: center; opacity: 0.4; transition: opacity 0.15s ease;
      color: #64748b; flex-shrink: 0;
    }
    .toast-close:hover { opacity: 0.9; }
    .toast-progress {
      position: absolute; bottom: 0; left: 0; height: 3px; width: 100%;
      border-radius: 0 0 12px 12px; animation: toastProgress 4s linear forwards;
    }
...
export class SignupComponent {
  ...
  onSubmit(): void {
    ...
    if (!this.isEmailValid) {
      this.showToast(`Email must be a valid Hyland address ending with ${REQUIRED_EMAIL_DOMAIN}`, 'error');
      return;
    }
    ...
    if (this.password !== this.confirmPassword) {
      this.showToast('Passwords do not match. Please verify both passwords.', 'error');
      return;
    }
    ...
    setTimeout(() => {
      const res = this.authService.signup(this.fullName, this.email, this.password);
      this.loading = false;

      if (res.success) {
        this.router.navigate(['/home']);
      } else {
        this.showToast(res.message || 'Signup failed.', 'error');
      }
    }, 400);
  }

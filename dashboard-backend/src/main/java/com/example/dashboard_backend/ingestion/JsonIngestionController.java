...
public class JsonIngestionController {
    ...
    public JsonIngestionController(JsonIngestionService jsonIngestionService) {
        ...
        @Operation(
            summary = "Analyze uploaded JSON file",
            description = "Accepts a multipart JSON file upload, inspects its structure, and returns inferred field metadata with sample rows before ingestion.",
            responses = {
                @ApiResponse(
                    responseCode = "200",
                    description = "Upload analyzed successfully",
                    content = @Content(
                        mediaType = "application/json",
                        schema = @Schema(implementation = UploadAnalysisResponse.class),
                        examples = @ExampleObject(value = "{\"uploadToken\":\"up_12345\",\"originalFilename\":\"orders.json\",\"rowCount\":120,\"columnCount\":4,\"fields\":[{\"fieldName\":\"region\",\"normalizedFieldName\":\"region\",\"fieldType\":\"STRING\",\"isDimension\":true,\"isMeasure\":false,\"distinctCount\":5,\"nullCount\":0,\"minValue\":null,\"maxValue\":null,\"sampleValues\":[\"North\",\"South\"]}],\"sampleRows\":[{\"region\":\"North\",\"revenue\":42000}],\"message\":\"Upload analyzed successfully\"}")
                    )
                ),
    ...
    public UploadAnalysisResponse uploadJson(@RequestParam("file") MultipartFile file) {
        ...
        @Operation(
            summary = "Ingest analyzed JSON data",
            description = "Persists a previously analyzed upload into a target table using the provided upload token and dataset payload.",
            requestBody = @RequestBody(
                required = true,
                content = @Content(
                    mediaType = "application/json",
                    schema = @Schema(implementation = IngestRequest.class),
                    examples = @ExampleObject(value = "{\"uploadToken\":\"up_12345\",\"userId\":\"demo-user\",\"tableName\":\"orders\",\"originalFilename\":\"orders.json\",\"data\":[{\"region\":\"North\",\"revenue\":42000},{\"region\":\"South\",\"revenue\":28000}]}")
                )
            ),
            responses = {
                @ApiResponse(
                    ...
                    content = @Content(
                        ...
                        examples = @ExampleObject(value = "{\"uploadId\":\"up_12345\",\"tableName\":\"orders\",\"rowsInserted\":120,\"columnCount\":4,\"status\":\"SUCCESS\",\"errors\":[],\"message\":\"Ingestion completed successfully\"}")
                    )
                ),
